...
Begin VB.Form online_collect_newfrm 
   BackColor       =   &H80000005&
   ...
   Begin VB.Frame Frame7 
      ...
      Begin Threed.SSCommand cmdDelRows 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":0000
         Caption         =   "Õ–› «·”œ«œ"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
   ...
   Begin VB.Frame Frame6 
      ...
      Begin Threed.SSCommand cmdScv 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":2434
         Caption         =   "› Õ „” ‰œ CSV"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
   ...
   Begin VB.Frame Frame3 
      ...
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":4A3F
         Caption         =   "√Ê·"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new3.frx":6BE6
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":8C2D
         Caption         =   "”«»ﬁ"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new3.frx":AD18
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":CD12
         Caption         =   "·«Õﬁ"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new3.frx":EE23
      End
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":10E1D
         Caption         =   "√ŒÌ—"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new3.frx":13041
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdInform 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":15112
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new3.frx":174DD
      End
      Begin Threed.SSCommand cmdNewInv 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":19586
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new3.frx":1B58E
      End
      Begin Threed.SSCommand cmddel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":1D545
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new3.frx":1FCE1
      End
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":22175
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":24498
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         ShapeSize       =   1
   ...
   Begin VB.Frame FRAME_CUR 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":268AC
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new3.frx":291D1
      End
      Begin Threed.SSCommand cmdUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new3.frx":2BA25
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new3.frx":2DB85
      End
   End
   ...
   End
End
Attribute VB_Name = "online_collect_newfrm"
...
ElseIf ActiveControl.Name = grid2.Name Then
    If Not GrdDesc(oSeachCode.grid1.TextMatrix(oSeachCode.grid1.Row, 0), "", grid2.Row, sMsg) Then
        If sMsg <> "" Then MsgBox sMsg
        Exit Sub
    End If
    Unload oSeachCode
...
With grid1
For i = 1 To grid1.Rows - 2
    .TextMatrix(i, 6) = .ValueMatrix(i, 4) - .ValueMatrix(i, 5)
    '.TextMatrix(i, 11) = Round(.ValueMatrix(i, 9) - .ValueMatrix(i, 10), 2)
    nTotal = mRound(nTotal + .ValueMatrix(i, 6))
...
With grid1
    For i = IIf(Row = -1, 1, Row) To IIf(Row = -1, grid1.Rows - 2, Row)
        ...
        aInsert = AddFlag(aInsert, "[COMMISSION]", grid1.ValueMatrix(i, 5))
...
ElseIf grid2.Row > 2 Then
    grid1.Editable = flexEDNone
ElseIf ((grid1.col = 0 Or grid1.col = 1 Or grid1.col = 2) And grid1.TextMatrix(grid1.Row, grid1.Cols - 1) = "") Or grid1.col = 4 Or grid1.col = 5 Then
...
'aFields(1) = "FILE9_10.ORDER_NO"
'aFields(2) = "FILE6_90H.[NAME]"
'aFields(3) = "FILE6_90H.[PHONE]"
'aFields(4) = "FILE9_10.[TOTAL]"
'aFields(5) = "FILE9_10.[COMMISSION]"
'aFields(6) = "FILE9_10.[VALUE]"
'aFields(7) = "vw_online_order_total.[total_plus]"
'aFields(8) = "vw_online_order_total.[total_minus]"
'aFields(9) = "vw_online_order_total.[total]"
'aFields(10) = "vw_online_order_pay.[VALUE]"
'aFields(11) = "CAST(NULL AS INT)"
'aFields(12) = "FILE9_10.ID"
'
'Dim cString As String
'cString = "SELECT " & arString(aFields, ",") & _
'         " FROM FILE9_10 " & _
'         " INNER JOIN FILE6_90H ON FILE9_10.ORDER_NO = FILE6_90H.DOC_NO" & _
'         " LEFT JOIN vw_online_order_pay ON FILE9_10.ORDER_NO = vw_online_order_pay.ORDER_NO" & _
...
.TextMatrix(0, 8) = "≈Ã„«·Ì «·›Ê« Ì—"
.TextMatrix(0, 9) = "≈Ã„«·Ì «·„— Ã⁄"
.TextMatrix(0, 10) = "’«›Ì «·›Ê« Ì—"
.TextMatrix(0, 11) = "≈Ã„«·Ì «·„”œœ"
.TextMatrix(0, 12) = "«·»«ﬁÌ"
.TextMatrix(0, 13) = "ID"
...
End If
End Sub
Private Function GrdDesc(ByVal sOrder_No As String, sPayment_id As String, Row As Long, ByRef pMsg As String) As Boolean
If sOrder_No = "" Then
...
With grid2
    For i = IIf(Row = -1, 1, Row) To IIf(Row = -1, .Rows - 2, Row)
        ...
        aInsert = AddFlag(aInsert, "[FEE]", .ValueMatrix(i, 5))
...
ElseIf grid1.Row > 2 Then
    grid2.Editable = flexEDNone
ElseIf ((grid2.col = 0 Or grid2.col = 1) And grid2.TextMatrix(grid2.Row, grid2.Cols - 1) = "") Or grid2.col = 4 Or grid2.col = 5 Then
...
'Dim cString As String
'Dim aFields(12)
'aFields(0) = "FILE9_10.ORDER_NO"
'aFields(1) = "FILE9_10.SHIP_NO"
'aFields(2) = "FILE6_90H.[NAME]"
'aFields(3) = "FILE6_90H.[PHONE]"
'aFields(4) = "FILE9_10.COD"
'aFields(5) = "FILE9_10.FEE"
'aFields(6) = "FILE9_10.[VALUE]"
'aFields(7) = "vw_online_order_total.[total_plus]"
'aFields(8) = "vw_online_order_total.[total_minus]"
'aFields(9) = "vw_online_order_total.[total]"
...
'cString = "SELECT " & arString(aFields, ",") & _
'         " FROM FILE9_10 " & _
'         " INNER JOIN FILE6_90H ON FILE6_90H.DOC_NO = FILE9_10.ORDER_NO" & _
'         " LEFT JOIN vw_online_order_pay ON FILE9_10.ORDER_NO = vw_online_order_pay.ORDER_NO" & _
'         " LEFT JOIN vw_online_order_total ON FILE9_10.ORDER_NO = vw_online_order_total.ORDER_NO" & _
'         " WHERE FILE9_10.DOC_NO = " & addvalue(xDoc_No.text) & _
'         " AND FILE9_10.TYPE = 2"
...
If bStopCell Then
    bStopCell = False
ElseIf col = 0 Then
    If NextEmpty(grid2, Row, col, 4) <= 2 Then
        ...
        End If
    Else
        grid2.Select Row, NextEmpty(grid2, Row, col, 4)
    End If
ElseIf col = 1 Then
    grid2.Select Row, NextEmpty(grid2, Row, col + 1, 4)
ElseIf col < 4 Then
    grid2.col = 4
ElseIf col < grid2.Cols - 9 Then
    grid2.col = col + 1
ElseIf Row < grid2.Rows - 1 Then
    grid2.Select Row + 1, NextEmpty(grid2, Row + 1, 1, 4)
