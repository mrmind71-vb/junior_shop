...
Private Sub myLoadGrd()
    ...
    Set data2.Recordset = cmd("sp_cust_phones", con, adStoredProc, aPrm).Execute
    Fixgrd
    If grid1.Rows = 1 Then
...
Sub Fixgrd()
    ...
    .TextMatrix(0, 0) = "«· ·Ì›Ê‰"
    .TextMatrix(0, 1) = "⁄œœ «·›Ê« Ì—"
    .TextMatrix(0, 2) = "ﬁÌ„… «·›Ê« Ì—"
    .TextMatrix(0, 3) = " «—ÌŒ «Œ—  ⁄«„·"
    .TextMatrix(0, 4) = " «—ÌŒ «Ê·  ⁄«„·"
