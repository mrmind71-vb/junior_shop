...
Begin VB.Form online_Stage_invoice 
   BackColor       =   &H00FFFFFF&
   Caption         =   " ÃÂÌ“ ÿ·»Ì…"
   ClientHeight    =   8010
   ClientLeft      =   60
      ...
      Begin VB.Frame Frame2 
         ...
         Begin Threed.SSCommand cmdExit 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "online_stage_invoice.frx":0000
            Alignment       =   8
            ButtonStyle     =   3
            PictureAlignment=   11
            BevelWidth      =   0
         ...
         Begin Threed.SSCommand cmdPrint 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "online_stage_invoice.frx":2323
            ButtonStyle     =   3
            PictureAlignment=   11
            BevelWidth      =   0
            PictureDisabledFrames=   1
            PictureDisabled =   "online_stage_invoice.frx":4699
         End
         Begin Threed.SSCommand cmdExcel 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "online_stage_invoice.frx":681C
            ButtonStyle     =   3
            PictureAlignment=   11
            BevelWidth      =   0
            ShapeSize       =   1
   ...
   End
End
Attribute VB_Name = "online_Stage_invoice"
...
If openCn(con) Then
    ...
    If Index = 4 Or (Index = 3 And xStage.Tag = "4") Or Index = 5 Or Index = 6 Then
        ...
        aInsert = AddFlag(aInsert, "MAN", addvalue(sManCode))
...
strSql = "SELECT TOP 1  ORDER_NO " & _
          " FROM vw_o" & _
          " FILE6_20H."
          " WHERE ORDER_NO = " & MyParn(sDoc_no)
