...
Begin VB.Form orders_clients_csv_sup 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin Threed.SSCommand cmdExcel 
         ...
         EndProperty
         Picture         =   "orders_clients_sup_tex.frx":0000
         Caption         =   " ’œÌ— Excel"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_sup_tex.frx":246A
         Caption         =   " ÿ»«⁄…"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "orders_clients_sup_tex.frx":47E0
      End
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_sup_tex.frx":6963
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdCSV 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_sup_tex.frx":8C86
         Caption         =   "”Õ» „‰ „·› CSV"
         TagVariant      =   "«Œ «— «·„ﬁ«Ê·"
         ButtonStyle     =   3
         PictureAlignment=   9
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_sup_tex.frx":B259
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "orders_clients_sup_tex.frx":DB7E
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TabCaption(0)   =   "«’‰«› €Ì— „ÊÃÊœ… ›Ï «·ÿ·»Ì… «·—∆Ì”Ì… «Ê »«—ﬂÊœ €Ì— ’«·Õ"
      TabPicture(0)   =   "orders_clients_sup_tex.frx":103D2
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "grid3"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "«’‰«› —’ÌœÂ« «ﬁ· „‰ «·ÿ·»Ì… «Ê »œÊ‰ —’Ìœ"
      TabPicture(1)   =   "orders_clients_sup_tex.frx":103EE
      ...
      TabCaption(2)   =   "«’‰«› ’«·Õ… ··ÿ·»Ì…"
      TabPicture(2)   =   "orders_clients_sup_tex.frx":1040A
   ...
   End
End
Attribute VB_Name = "orders_clients_csv_sup"
...
ElseIf SSTab1.Tab = 3 Then
    printGrdNew.doPrint Grid3, 0.95, 0, "ÃÊ‰ÌÊ—", Me.Caption, ArbString(retHeader(aHeader, 0, 5)), SSTab1.TabCaption(3), False, False, 10
End If
printGrdNew.Show 1
End Sub
    ...
    If sItem <> "" And nQuant > 0 Then
         ...
         If Not locTable.EOF Then
            If locTable!ISDOZ Then
                nQuant = Round(nQuant / 12, 2)
            End If
            
            If Val(locTable!balance) > 0 Then
                grid1.AddItem ""
                ...
                If Val(locTable!balance) >= nQuant Then
