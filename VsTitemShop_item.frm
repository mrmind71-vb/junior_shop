...
Begin VB.Form VsTitemShop_item 
   ...
   Begin VB.Frame Frame7 
      ...
      Top             =   2565
      Width           =   4920
      Begin VB.CheckBox chkItemsOnly 
...
If MsgBox("Õ–› «·ÿ·»Ì«  ··„ÊœÌ·«  «·„Õœœ… «·Œ«’… »«·›—⁄ ", vbYesNo + vbDefaultButton2) = vbYes Then
    With grid1
        ...
        For nRow = 3 To .Rows - 1
            prog1.Value = nRow
            If Val(.TextMatrix(nRow, 19)) > 0 Then
...
'   CMD_PRINTORDER.Visible = (cBranch <> "00")
    ...
    Dim cSql  As String
    If cBranch <> "00" Then
       cSql = "S_BRANCH = " & MyParn(cBranch)
    End If
    cSql = cSql & Tr(cSql) & cUserStore
    
    cSql = "Select Code,DescA From STORE_BR WHERE " & cSql
    Set data10.Recordset = cmd(cSql, con).Execute
    Set xStore.RowSource = data10
    xStore.ListField = "Desca"
    xStore.BoundColumn = "Code"
    If cBranch <> "00" Then
        xStore.BoundText = cBranchStore
        xStore.Enabled = data10.Recordset.RecordCount > 1
    Else
...
'   .ColComboList(17) = "..."
    ...
    .Subtotal flexSTSum, -1, 15 + 2, "##0", , RGB(255, 0, 0), True, "≈Ã„«·Ï"
...
Private Function retWhere() As String
    ...
    If chkItemsOnly.Value = 1 Then
        cWhere.Append " AND file1_10.ISNOITEM = 0 AND FILE1_10.ISNOITEM2 = 0"
    End If
