...
Begin VB.Form orders_clients_tex 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin Threed.SSCommand cmdExcel 
         ...
         EndProperty
         Picture         =   "orders_clients_tex.frx":0000
         Caption         =   " ’œÌ— Excel"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex.frx":246A
         Caption         =   " ÿ»«⁄…"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "orders_clients_tex.frx":47E0
      End
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex.frx":6963
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdCSV 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex.frx":8C86
         Caption         =   "«⁄«œ… ”Õ» «·„” ‰œ"
         TagVariant      =   "«Œ «— «·„ﬁ«Ê·"
         ButtonStyle     =   3
         PictureAlignment=   9
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex.frx":B259
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "orders_clients_tex.frx":DB7E
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "orders_clients_tex.frx":103D2
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "grid3"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "«’‰«› —’ÌœÂ« «ﬁ· „‰ «·ÿ·»Ì… «Ê »œÊ‰ —’Ìœ"
      TabPicture(1)   =   "orders_clients_tex.frx":103EE
      ...
      TabCaption(2)   =   "«’‰«› ’«·Õ… ··ÿ·»Ì…"
      TabPicture(2)   =   "orders_clients_tex.frx":1040A
   ...
   End
End
Attribute VB_Name = "orders_clients_tex"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public sdoc_no_copy As String
...
If SSTab1.Tab = 1 Then
    ToFileExelNew grid1, , , aRow, Array(1), 0.9, , , , , , Me, Array(Me.Caption, SSTab1.TabCaption(1))
ElseIf SSTab1.Tab = 1 = 2 Then
    ToFileExelNew grid2, , , aRow, Array(1), 0.9, , , , , , Me, Array(Me.Caption, SSTab1.TabCaption(2))
ElseIf SSTab1.Tab = 1 = 3 Then
    ToFileExelNew grid3, , , aRow, Array(1), 0.9, , , , , , Me, Array(Me.Caption, SSTab1.TabCaption(3))
End If
End Sub
...
If SSTab1.Tab = 1 Then
    printGrdNew.doPrint grid1, 0.85, 0, "ÃÊ‰ÌÊ—", Me.Caption, ArbString(retHeader(aHeader, 0, 5)), SSTab1.TabCaption(1), False, True, 10
ElseIf SSTab1.Tab = 2 Then
    printGrdNew.doPrint grid2, 0.85, 0, "ÃÊ‰ÌÊ—", Me.Caption, ArbString(retHeader(aHeader, 0, 5)), SSTab1.TabCaption(2), False, True, 10
ElseIf SSTab1.Tab = 3 Then
    printGrdNew.doPrint grid3, 0.95, 0, "ÃÊ‰ÌÊ—", Me.Caption, ArbString(retHeader(aHeader, 0, 5)), SSTab1.TabCaption(2), False, False, 10
End If
printGrdNew.Show 1
End Sub
...
db.Sql = "UPDATE FILE6_50H " & _
         " SET  FILE6_50H.Pur_Order = " & MyParn(sdoc_no_copy) & _
         ", CHANGED = 1 " & _
...
If Not checkBalance Then Exit Sub
If myreplace Then
    myform.myProc "PUR_ORDER"
    Unload Me
End If
End Sub
...
For i = 1 To grid1.Rows - 1
    sb.Append MyParn(grid1.TextMatrix(i, 1)) & ","
Next
sb.Shorten 1
...
For i = 1 To grid1.Rows - 1
    ...
    locTable.Find "ITEM = " & MyParn(grid1.TextMatrix(i, 1)), , adSearchForward, adBookmarkFirst
    If locTable.EOF Then
        MsgBox ("’‰› €Ì— „ÊÃÊœ ›Ï «’‰«› «· ÿ»Ìﬁ «·—Ã«¡ „—«Ã⁄… «·»Ì«‰«  «Ê ”Õ» «·„·› „—… «Œ—Ì")
        GoTo cleanUp
    ElseIf Val(locTable!balance) <> Val(grid1.ValueMatrix(i, 7)) Then
        MsgBox (" €ÌÌ— ›Ï —’Ìœ «·ÿ·»Ì… «·—Ã«¡ ”Õ» «·„·› „—… «Œ—Ì Ê”—⁄… «·Õ›Ÿ")
        GoTo cleanUp
    End If
Next
checkBalance = True
...
Set dbm = Nothing
Set orders_clients_csv = Nothing
End Sub
...
Dim dbTex As New clsDb
Dim db As New clsDb

dbTex.connectionString = getConShopString
Dim sourceTable As ADODB.RecordSet
Set sourceTable = dbTex.myRs("SELECT FILE6_50.QUANT," & _
                             " FILE1_10.BARCODE AS ITEM" & _
                             " FROM FILE6_50 " & _
                             " INNER JOIN FILE1_10 ON FILE6_50.ITEM = FILE1_10.ITEM " & _
                             " WHERE FILE6_50.DOC_NO = " & MyParn(sdoc_no_copy))
                             
If sourceTable Is Nothing Then GoTo cleanUp
If sourceTable.EOF Then GoTo cleanUp

Dim sb As New ChilkatStringBuilder
Do Until sourceTable.EOF
    sb.Append MyParn(sourceTable!item) & ","
...
prog1.Visible = True
Do Until sourceTable.EOF
    Me.Caption = sCaption & " - " & "”Ã· " & (i + 1) & " „‰ " & locTable.RecordCount
    prog1.Value = Round(i / sourceTable.RecordCount, 2) * 100
    locTable.Find "ITEM = " & MyParn(sourceTable!item), , adSearchForward, adBookmarkFirst
    If Not locTable.EOF Then
        If locTable!ISDOZ Then
            nQuant = Round(sourceTable!Quant / 12, 2)
        Else
            nQuant = sourceTable!Quant
        End If
        ...
        If Val(locTable!balance) > 0 Or Not locTable!check_Bal Then
            ...
            grid1.TextMatrix(grid1.Rows - 1, 8) = nQuant
            If Val(locTable!balance) >= nQuant Or Not locTable!check_Bal Then
        ...
        If Val(locTable!balance) < nQuant And locTable!check_Bal Then
            grid2.AddItem ""
            ...
            grid2.TextMatrix(grid2.Rows - 1, 8) = nQuant
            grid2.TextMatrix(grid2.Rows - 1, 9) = IIf(locTable!balance > 0, locTable!balance, 0)
        End If
    Else
        grid3.AddItem ""
        grid3.TextMatrix(grid3.Rows - 1, 0) = grid3.Rows - 1
        grid3.TextMatrix(grid3.Rows - 1, 1) = sourceTable!item
        grid3.TextMatrix(grid2.Rows - 1, 9) = nQuant
    End If
    sourceTable.MoveNext
Loop
cleanUp:
