...
Begin VB.Form online_collect_newfrm 
   ...
   Begin VB.Frame Frame7 
      ...
      Begin Threed.SSCommand cmdDelRows 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":0000
         Caption         =   "Õ–› «·”œ«œ"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
   ...
   Begin VB.Frame Frame6 
      ...
      Begin Threed.SSCommand cmdScv 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":2434
         Caption         =   "› Õ „” ‰œ CSV"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "online_collect_new.frx":4A07
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "grid2"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "”œ«œ ‘—ﬂ… «·‘Õ‰"
      TabPicture(1)   =   "online_collect_new.frx":4A23
   ...
   Begin VB.Frame Frame3 
      ...
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":4A3F
         Caption         =   "√Ê·"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new.frx":6BE6
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":8C2D
         Caption         =   "”«»ﬁ"
         ButtonStyle     =   3
         PictureAlignment=   10
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new.frx":AD18
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":CD12
         Caption         =   "·«Õﬁ"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new.frx":EE23
      End
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":10E1D
         Caption         =   "√ŒÌ—"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "online_collect_new.frx":13041
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdInform 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":15112
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new.frx":174DD
      End
      Begin Threed.SSCommand cmdNewInv 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":19586
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new.frx":1B58E
      End
      Begin Threed.SSCommand cmddel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":1D545
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new.frx":1FCE1
      End
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":22175
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":24498
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         ShapeSize       =   1
   ...
   Begin VB.Frame FRAME_CUR 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":268AC
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new.frx":291D1
      End
      Begin Threed.SSCommand cmdUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_collect_new.frx":2BA25
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_collect_new.frx":2DB85
      End
   End
...
'aFields(4) = "ONLINE_PAY_SUP.[TOTAL]"
'aFields(5) = "ONLINE_PAY_SUP.[COMMISSION]"
'aFields(6) = "ONLINE_PAY_SUP.[VALUE]"
...
'aFields(12) = "ONLINE_PAY_SUP.ID"
'
'Dim cString As String
'cString = "SELECT " & arString(aFields, ",") & _
'         " FROM ONLINE_PAY_SUP " & _
'         " INNER JOIN FILE6_90H ON ONLINE_PAY_SUP.ORDER_NO = FILE6_90H.DOC_NO" & _
'         " LEFT JOIN vw_online_order_pay ON ONLINE_PAY_SUP.ORDER_NO = vw_online_order_pay.ORDER_NO" & _
'         " LEFT JOIN vw_online_order_total ON ONLINE_PAY_SUP.ORDER_NO = vw_online_order_total.ORDER_NO" & _
...
'aFields(2) = "FILE6_90H.[NAME]"
'aFields(3) = "FILE6_90H.[PHONE]"
'aFields(4) = "ONLINE_PAY_SUP.COD"
'aFields(5) = "ONLINE_PAY_SUP.FEE"
'aFields(6) = "ONLINE_PAY_SUP.[VALUE]"
'aFields(7) = "vw_online_order_total.[total_plus]"
'aFields(8) = "vw_online_order_total.[total_minus]"
'aFields(9) = "vw_online_order_total.[total]"
...
'cString = "SELECT " & arString(aFields, ",") & _
'         " FROM ONLINE_PAY_SUP " & _
'         " INNER JOIN FILE6_90H ON FILE6_90H.DOC_NO = ONLINE_PAY_SUP.ORDER_NO" & _
'         " LEFT JOIN vw_online_order_pay ON ONLINE_PAY_SUP.ORDER_NO = vw_online_order_pay.ORDER_NO" & _
'         " LEFT JOIN vw_online_order_total ON ONLINE_PAY_SUP.ORDER_NO = vw_online_order_total.ORDER_NO" & _
'         " WHERE ONLINE_PAY_SUP.DOC_NO = " & addvalue(xDoc_No.text) & _
