...
Begin VB.Form online_orders_popup 
   BackColor       =   &H00FFFFFF&
   Caption         =   "»Ê«·’ «·‘Õ‰"
   ClientHeight    =   11055
   ClientLeft      =   60
      ...
      Begin VB.Frame Frame4 
         ...
         Begin Threed.SSCommand cmdExit 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "online_orders_popup.frx":0000
            Caption         =   "///"
            Alignment       =   8
            ButtonStyle     =   3
            PictureAlignment=   11
         ...
         Begin Threed.SSCommand cmdGo 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "online_orders_popup.frx":2323
            ButtonStyle     =   3
            PictureAlignment=   11
            BevelWidth      =   0
            ShapeSize       =   1
         ...
         Begin Threed.SSCommand cmdExcel 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "online_orders_popup.frx":51D6
            ButtonStyle     =   3
            PictureAlignment=   11
            BevelWidth      =   0
            ShapeSize       =   1
   ...
   End
End
Attribute VB_Name = "online_orders_popUp"
...
strSql = "SELECT v.[ORDER_NO]" & _
          ...
          ",[TOTAL_ITEM]" & _
          ",[DISCOUNT]" & _
          ",[TOTAL_ITEM] - [DISCOUNT]" & _
          ",v.[INV_NO]" & _
          ",CASE WHEN CLOSED = 1 THEN '„€·›…' WHEN CANCELED = 1 THEN '„·€«…' ELSE '„› ÊÕ…' END" & _
          ",s.DATE_PICK" & _
          " FROM [vw_online_orders]  v" & _
          " INNER JOIN STAGES_CODES ON v.stage = STAGES_CODES.code" & _
          " LEFT JOIN FILE6_90S s ON v.ORDER_NO = s.ORDER_NO AND v.ORDER_NO_SUP = s.ORDER_NO_SUP" & _
          " LEFT JOIN ONLINE_TYPES t ON v.TYPE = t.CODE" & _
          " WHERE v.[TYPE] IN(0,1,2,3,11,12)"

cWhere = retWhere

If cWhere <> "" Then
    strSql = strSql & " AND " & cWhere
End If

strSql = strSql & "  order by date desc,v.[ORDER_NO]"
...
.TextMatrix(0, 5) = "«·«”„"
.TextMatrix(0, 6) = "«·„—Õ·…"
.TextMatrix(0, 7) = "≈Ã„«·Ì «·ﬂ„Ì…"
.TextMatrix(0, 8) = "ﬁÌ„… «·ÿ·»Ì…"
.TextMatrix(0, 9) = "«·Œ’„"
.TextMatrix(0, 10) = "’«›Ì «·ÿ·»Ì…"
.TextMatrix(0, 11) = "—ﬁ„ «·›« Ê—…"
.TextMatrix(0, 12) = "Õ«·… «·ÿ·»Ì…"
.TextMatrix(0, 13) = " «—ÌŒ «·‘Õ‰"
