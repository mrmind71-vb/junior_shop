...
If chkMain.Value = 0 Then
    cString = myPrcString("[dbo].[sp_sup_balance]", aPrm)
Else
    cString = myPrcString("[dbo].[sp_sup_balance_main]", aPrm)
End If
...
.WordWrap = True
    ...
    .TextMatrix(0, 2 + 1) = "«·—’Ìœ " & xDate1.text
    .TextMatrix(0, 3 + 1) = "Ã. „‘ —Ì« "
    .TextMatrix(0, 4 + 1) = "Ã. „— Ã⁄«  "
    .TextMatrix(0, 5 + 1) = "’«›Ï ﬁÌ„… „‘ —Ì« "
    
    .TextMatrix(0, 6 + 1) = "”œ«œ ‰ﬁœÏ"
    .TextMatrix(0, 7 + 1) = "”œ«œ √.œ"
    .TextMatrix(0, 8 + 1) = " ”ÊÌ« "
    .TextMatrix(0, 9 + 1) = "„’«—Ì›"
    .TextMatrix(0, 10 + 1) = "Õ”«»« "
    .TextMatrix(0, 11 + 1) = "—’Ìœ " & xDate2.text
    .TextMatrix(0, 12 + 1) = "√.œ  Õ  «· Õ’Ì·"
    
    .TextMatrix(0, 13 + 1) = "—’Ìœ »÷«⁄… «„«‰« "
    .TextMatrix(0, 14 + 1) = "«·„” Õﬁ"
    .TextMatrix(0, 15 + 1) = " ﬂ·›… „»Ì⁄«  «„«‰« "
