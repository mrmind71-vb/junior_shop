...
Begin VB.Form grdOkaz_newfrm 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "grdokaz_new.frx":2323
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "grdokaz_new.frx":4699
      End
   ...
   End
End
Attribute VB_Name = "grdOkaz_newfrm"
...
grid1(1).Tag = "dbo.sp_okaz_model"
grid1(2).Tag = "dbo.sp_okaz_doc"
grid1(3).Tag = "dbo.sp_okaz_sup"
grid1(4).Tag = "dbo.sp_okaz_store"
grid1(5).Tag = "dbo.sp_okaz_doc_group"
grid1(6).Tag = "dbo.sp_okaz_section"
grid1(7).Tag = "dbo.sp_okaz_doc_branch"
...
If Index = 1 Then
    ...
    If .Rows > 1 Then
        If .ValueMatrix(1, 8) <> 0 Then
            ...
            .TextMatrix(1, 14 + 1) = mRound((.ValueMatrix(1, 13 + 1) - .ValueMatrix(1, 8)) / .ValueMatrix(1, 8), 4)
        End If
    End If
ElseIf Index = 2 Then
    .Cols = 16
    ...
    .TextMatrix(0, 13 + 1) = "ﬁÌ„… »”⁄— „” Â·ﬂ"
    .TextMatrix(0, 14 + 1) = "‰”»… „” Â·ﬂ"
    ...
    If .Rows > 1 Then
        For i = 1 To grid1(Index).Rows - 1
            If .ValueMatrix(i, 8) <> 0 And InStr(grid1(Index).TextMatrix(i, 0), "≈Ã„«·Ï") > 0 Then
                ...
                .TextMatrix(i, 14 + 1) = mRound((.ValueMatrix(i, 13 + 1) - .ValueMatrix(i, 8)) / .ValueMatrix(i, 8), 4)
            End If
        Next
    End If
...
ElseIf Index = 3 Or Index = 4 Or Index = 5 Then
    ...
    .TextMatrix(0, 9 + 1) = "ﬁÌ„… »”⁄— „” Â·ﬂ"
    .TextMatrix(0, 10 + 1) = "‰”»… „” Â·ﬂ"
    
    
   
    .ColHidden(4 + 1) = Not bOpt10
    .ColHidden(5 + 1) = Not bOpt10
    .ColHidden(6 + 1) = Not bOpt10
    ...
    If .Rows > 1 Then
        If .ValueMatrix(1, 4) <> 0 Then
            ...
            .TextMatrix(1, 10 + 1) = mRound((.ValueMatrix(1, 9 + 1) - .ValueMatrix(1, 4)) / .ValueMatrix(1, 4), 4)
        End If
    End If
...
ElseIf Index = 6 And (optSection(1).Value Or optSection(2).Value) Then
    ...
    .TextMatrix(0, 11 + 1) = "ﬁÌ„… »”⁄— „” Â·ﬂ"
    .TextMatrix(0, 12 + 1) = "‰”»… „” Â·ﬂ"
    ...
    If .Rows > 1 Then
        If .ValueMatrix(1, 6) <> 0 Then
            .TextMatrix(1, 8) = mRound(.ValueMatrix(1, 7) / .ValueMatrix(1, 6), 4)
            .TextMatrix(1, 12 + 1) = mRound((.ValueMatrix(1, 11 + 1) - .ValueMatrix(1, 6)) / .ValueMatrix(1, 6), 4)
        End If
        .TextMatrix(1, 1) = "«·≈Ã„«·Ì"
    End If
    ...
    For i = 1 To .Rows - 1
        If Left(.TextMatrix(i, 1), 6) = "≈Ã„«·Ì" And .TextMatrix(i, 2) = "" Then
            If .ValueMatrix(i, 6) <> 0 Then
                .TextMatrix(i, 8) = mRound(.ValueMatrix(i, 7) / .ValueMatrix(i, 6), 4)
                .TextMatrix(i, 12 + 1) = mRound((.ValueMatrix(i, 11 + 1) - .ValueMatrix(i, 6)) / .ValueMatrix(i, 6), 4)
            End If
        End If
    Next
ElseIf Index = 7 Then
...
If Index = 1 Then
    grid1(6).Tag = "dbo.sp_okaz_section_branch"
ElseIf Index = 2 Then
    grid1(6).Tag = "dbo.sp_okaz_section_branch2"
Else
    grid1(6).Tag = "dbo.sp_okaz_section"
End If
End Sub
