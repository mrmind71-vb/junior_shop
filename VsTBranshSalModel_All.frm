...
Private Sub Form_Load()
    ...
    StoreTable.Open "select STORE_BR.CODE , STORE_BR.DESCA FROM STORE_BR WHERE ISSTOP = 0 AND " & cUserStore, con, adOpenStatic, adLockReadOnly, adCmdText
    
    Set DATA7.Recordset = myRecordSet("Select Code,DescA From STORE_BR WHERE ISSTOP = 0 AND" & cUserStore, con)
