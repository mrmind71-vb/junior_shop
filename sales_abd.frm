...
Begin VB.Form sales_abdfrm 
   ...
   Begin VB.Frame FRAME_CUR 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":2B6AE
      End
      Begin Threed.SSCommand cmdUndo 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":30062
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdInform 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":3471A
      End
      Begin Threed.SSCommand cmdNewInv 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":387CB
      End
      Begin Threed.SSCommand cmddel 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":3CF1E
      End
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_abd.frx":416D5
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "sales_abd.frx":43A4B
      End
   End
   Begin VB.Frame Frame17 
      ...
      Begin Threed.SSCommand cmd_tsal 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":482A0
      End
      Begin Threed.SSCommand cmdPrintDay 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":4CE1A
      End
      Begin Threed.SSCommand cmdPrintDayTotal 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_abd.frx":51960
      End
   End
...
Else
    retFilter = retFilter & " AND FILE6_20H.BRANCH > '00'"
End If
