...
Begin VB.Form sales_wholefrm 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Frame fmDate 
         ...
         Begin Threed.SSCommand DAYALL1 
            ...
            ShapeSize       =   1
            PictureDisabled =   "sales_whole.frx":6B1A
         End
      ...
      Begin VB.Frame Frame6 
         ...
         Begin Threed.SSCommand cmdFirst 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "sales_whole.frx":8C36
            Caption         =   "√Ê·"
            ButtonStyle     =   3
            PictureAlignment=   10
            BevelWidth      =   0
            PictureDisabledFrames=   1
            PictureDisabled =   "sales_whole.frx":ADDD
         End
         Begin Threed.SSCommand cmdPrevious 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "sales_whole.frx":CE24
            Caption         =   "”«»ﬁ"
            ButtonStyle     =   3
            PictureAlignment=   10
            BevelWidth      =   0
            PictureDisabledFrames=   1
            PictureDisabled =   "sales_whole.frx":EF0F
         End
         Begin Threed.SSCommand cmdNext 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "sales_whole.frx":10F09
            Caption         =   "·«Õﬁ"
            ButtonStyle     =   3
            PictureAlignment=   9
            BevelWidth      =   0
            PictureDisabledFrames=   1
            PictureDisabled =   "sales_whole.frx":1301A
         End
         Begin Threed.SSCommand cmdLast 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            Picture         =   "sales_whole.frx":15014
            Caption         =   "√ŒÌ—"
            ButtonStyle     =   3
            PictureAlignment=   9
            BevelWidth      =   0
            PictureDisabledFrames=   1
            PictureDisabled =   "sales_whole.frx":17238
         End
      End
   ...
   Begin VB.Frame FRAME_CUR 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_whole.frx":1BC2E
      End
      Begin Threed.SSCommand cmdUndo 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_whole.frx":205E2
      End
   End
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_whole.frx":31C55
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "sales_whole.frx":33FCB
      End
   End
...
If xDoc_no.Tag = DefineMode Then
    xDoc_no.text = IncData("FILE6_20H", "DOC_NO", con, "FILE6_20H.INV_TYPE = 2")
...
Dim nHeight As Long
nHeight = Me.Height - (grid1.Top + 2470)
...
If myreplace(Row) Then
    ...
    ElseIf grid1.TextMatrix(Row, grid1.Cols - 1) = "" Then
        ...
        grid1.TextMatrix(Row, 13) = fnBalance(grid1.TextMatrix(Row, 1), con, xStore.BoundText) & ""
        'myLoadGrd
    End If
    If bNew Then
        'bStopCell = True
...
xDiscount.Enabled = bEditRecord
xRate.Enabled = bEditRecord
...
grid1.TextMatrix(Row, 12) = cm.Parameters("@COST").Value
grid1.TextMatrix(Row, 13) = fnBalance(cm.Parameters("@ITEM").Value, con, xStore.BoundText) & ""
GrdDesc = True
End With
End Function
...
For i = 1 To grid1.Rows - 2
    .TextMatrix(i, 11) = .ValueMatrix(i, 10) * .ValueMatrix(i, 9)
    nTotalQuant = nTotalQuant + grid1.ValueMatrix(i, 9)
    nTotalItem = mRound(nTotalItem + (.ValueMatrix(i, 9) * .ValueMatrix(i, 10)))
Next
...
.FormatString = "„.|" & "»«—ﬂÊœ|" & "„Ê”„|" & "„’‰⁄|" & "„ﬂ »|" & "—ﬁ„ „ÊœÌ·|" & "«·’‰›|" & "„ﬁ«”|" & "«··Ê‰|" & "⁄œœ|" & "”⁄— «·»Ì⁄|" & "«·≈Ã„«·Ï|" & "«· ﬂ·›…|" & "«·—’Ìœ|"
.RowHeight(0) = 600
.WordWrap = True
...
With grid1
    For i = IIf(Row = -1, 1, Row) To IIf(Row = -1, grid1.Rows - 2, Row)
        ...
        aInsert = AddFlag(aInsert, "PRICE", .ValueMatrix(i, 10))
        aInsert = AddFlag(aInsert, "COST", .ValueMatrix(i, 12))
...
retFilter = "FILE6_20H.INV_TYPE = 2"
