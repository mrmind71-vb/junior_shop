...
Begin VB.Form purchasefrm 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "SEND"
      TabPicture(0)   =   "purchase4.frx":0008
   ...
   Begin VB.Frame Frame5 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchase4.frx":72A9
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchase4.frx":9479
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchase4.frx":B5C1
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchase4.frx":D789
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchase4.frx":F8D8
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchase4.frx":11AB8
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "purchase4.frx":13C13
         Caption         =   " «Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "purchase4.frx":15DCF
      End
   End
...
If MsgBox("Õ–› «·„” ‰œ »«·ﬂ«„·  ?, Â· «‰  „Ê«›ﬁ ø", 1 + 256) = vbOK Then
    ...
    AddLod_Data cUserName, 2, " Õ–› „‘ —Ì«  ", con, xdoc_no.text, xDate.text
...
ElseIf grid1.col = 9 Or grid1.col = 15 Or grid1.col = 8 Then
...
Private Sub Handlecontrols(nMode)
    ...
    CMD_ADDRETURN.Enabled = bEditRecord
    CMD_ADDBAL.Enabled = bEditRecord
    CMD_FIXSEC.Enabled = bEditRecord
    FIX_FACTITEM.Enabled = bEditRecord
    ...
    CMD_ALL.Enabled = (xClosed.Value = 0) And bEditRecord
    cmdNewInv.Enabled = nMode = LoadMode And bEdit
    cmd_closed.Enabled = nMode = LoadMode And bEdit
    GRD_REC.Editable = (xClosed.Value = 0) And xdoc_no.text <> ""
    cmdFirst.Enabled = (nMode = LoadMode)
    cmdLast.Enabled = (nMode = LoadMode)
    cmdNext.Enabled = (nMode = LoadMode)
    cmdPrevious.Enabled = (nMode = LoadMode)
    xClosed.Enabled = (nMode = LoadMode) And bEdit
