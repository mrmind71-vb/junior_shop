...
Begin VB.Form sales_refundfrm 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin Threed.SSCommand cmdSend 
         ...
         ShapeSize       =   1
         PictureDisabled =   "sales_refund.frx":4977
      End
      Begin Threed.SSCommand cmdSelectAll 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_refund.frx":92ED
      End
      Begin Threed.SSCommand cmdDelAll 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "sales_refund.frx":DC7D
      End
   End
