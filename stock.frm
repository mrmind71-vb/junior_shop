...
Generalarray(1) = "SELECT DOC_NO,DATE, CONVERT(VARCHAR(10),[DATE],111),FILE0_40.DESCA,FILE0_10H.DESCA ,FILE0_10H.CLOSED " & _
                  " FROM (FILE0_10H INNER JOIN FILE0_40 ON FILE0_10H.Store = FILE0_40.CODE) WHERE FILE0_10H.IS_ZONE = 0 "
...
ElseIf (grid1.col = 0 Or grid1.col = 8) And cmdSave.Enabled Then
...
cmdPost.Enabled = (Not bClosed) And nMode = LoadMode And bEdit
cmdUnpost.Enabled = bClosed And bEdit And nMode = LoadMode And bEdit
cmdFix.Enabled = (Not bClosed) And bEdit And nMode = LoadMode And bEdit
cmdSave.Enabled = (nMode = DefineMode Or Not bClosed) And bEdit
CmdDelInv.Enabled = (Not bClosed) And nMode = LoadMode And beidt
Command2.Enabled = (Not bClosed) And nMode = LoadMode And bEdit
cmdDelAdd.Enabled = (Not bClosed) And nMode = LoadMode And bEdit
...
cString = "SELECT TOP 1 * from FILE0_10H WHERE FILE0_10H.IS_ZONE = 0"
