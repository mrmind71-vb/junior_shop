...
Begin VB.Form orders_clients_tex_sup 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin Threed.SSCommand cmdExcel 
         ...
         EndProperty
         Picture         =   "orders_clients_tex_sup.frx":0000
         Caption         =   " ’œÌ— Excel"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdPrint 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex_sup.frx":246A
         Caption         =   " ÿ»«⁄…"
         ButtonStyle     =   3
         PictureAlignment=   9
         BevelWidth      =   0
         PictureDisabledFrames=   1
         PictureDisabled =   "orders_clients_tex_sup.frx":47E0
      End
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex_sup.frx":6963
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdCSV 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex_sup.frx":8C86
         Caption         =   "«⁄«œ… ”Õ» «·„” ‰œ"
         TagVariant      =   "«Œ «— «·„ﬁ«Ê·"
         ButtonStyle     =   3
         PictureAlignment=   9
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "orders_clients_tex_sup.frx":B259
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "orders_clients_tex_sup.frx":DB7E
      End
   End
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "orders_clients_tex_sup.frx":103D2
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "grid3"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "«’‰«› —’ÌœÂ« «ﬁ· „‰ «·ÿ·»Ì… «Ê »œÊ‰ —’Ìœ"
      TabPicture(1)   =   "orders_clients_tex_sup.frx":103EE
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Option2(0)"
      Tab(1).Control(1)=   "Option2(1)"
      Tab(1).Control(2)=   "Option2(2)"
      Tab(1).Control(3)=   "grid2"
      Tab(1).ControlCount=   4
      TabCaption(2)   =   "«’‰«› ’«·Õ… ··ÿ·»Ì…"
      TabPicture(2)   =   "orders_clients_tex_sup.frx":1040A
   ...
   End
End
Attribute VB_Name = "orders_clients_tex_sup"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Public sdoc_no_copy As String
Public sorder_no_main As String
...
strSql = "SELECT * " & _
          " FROM vw_items_orders_sup" & _
          " where doc_no = " & MyParn(sorder_no_main)

Dim locTable As ADODB.RecordSet
Set locTable = db.myRs(strSql): If locTable Is Nothing Then GoTo cleanUp
...
Do Until sourceTable.EOF
    ...
    Else
       ...
       Else
           ...
           grid3.TextMatrix(grid3.Rows - 1, 9) = nQuant
       End If
    End If
    sourceTable.MoveNext
Loop
