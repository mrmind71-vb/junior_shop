...
Begin VB.Form shipping_check 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin Threed.SSCommand CMD_SEND 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "shipping_check.frx":0000
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         ...
         ShapeSize       =   1
         PictureDisabled =   "shipping_check.frx":2925
      End
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "shipping_check.frx":5179
         Alignment       =   8
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
      ...
      Begin Threed.SSCommand cmdExcel 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "shipping_check.frx":749C
         ButtonStyle     =   3
         PictureAlignment=   11
         BevelWidth      =   0
         ShapeSize       =   1
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "shipping_check.frx":98B0
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "GRID2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "”œ«œ ‘—ﬂ… «·‘Õ‰"
      TabPicture(1)   =   "shipping_check.frx":98CC
   ...
   End
End
Attribute VB_Name = "shipping_check"
