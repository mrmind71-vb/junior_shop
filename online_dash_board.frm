...
Begin VB.Form online_dash_board 
   ...
   Begin VB.Frame Frame6 
      Caption         =   "ÑÕíÏ ØáÈÈÇÊ ÛíÑ ãäÝÐÉ ááÝÑæÚ"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   178
...
.WordWrap = True
.TextMatrix(0, 0) = "äæÚ ÇáØáÈíÉ"
.ColWidth(0) = 2000
.TextMatrix(1, 0) = "äæÚ ÇáØáÈíÉ"

Dim i As Long
For i = 1 To 4
    .TextMatrix(0, i) = "ØáÈíÇÊ"
Next
...
.TextMatrix(1, 2) = "ÞØÛ"
.ColWidth(2) = 1000
.TextMatrix(1, 3) = "ÅÌãÇáì"
.ColWidth(3) = 1500
.TextMatrix(1, 4) = "ãÊæÓØ"
.ColWidth(4) = 1000

For i = 5 To 9
    .TextMatrix(0, i) = "ÇáãÈÇÚ"
Next
.TextMatrix(1, 5) = "ÚÏÏ"
.ColWidth(5) = 1000
.TextMatrix(1, 6) = "ÞØÚ"
...
.TextMatrix(1, 8) = "äÓíÉ"
.ColWidth(8) = 1000
.TextMatrix(1, 9) = "ãÊæÓØ"
.ColWidth(9) = 1000

For i = 10 To 14
    .TextMatrix(0, i) = "ÛíÑ ãÈÇÚ"
Next
.TextMatrix(1, 10) = "ÚÏÏ"
.ColWidth(10) = 1000
.TextMatrix(1, 11) = "ÞØÚ"
.ColWidth(11) = 1000
.TextMatrix(1, 12) = "ÞíãÉ"
.ColWidth(12) = 1500
.TextMatrix(1, 13) = "äÓíÉ"
.ColWidth(13) = 1000
.TextMatrix(1, 14) = "ãÊæÓØ"
.ColWidth(14) = 1000
