...
Begin VB.Form orders_online_items 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin Threed.SSCommand cmdSend 
         ...
         ShapeSize       =   1
         PictureDisabled =   "online_orders_def.frx":2723
      End
   End
   Begin VB.Frame fmAddInvoice 
      ...
      Begin Threed.SSCommand cmdAddInvoice 
         ...
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_orders_def.frx":4A19
      End
   End
   Begin VB.Frame Frame4 
      ...
      Begin Threed.SSCommand cmdExit 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_orders_def.frx":6D0F
         Alignment       =   8
         ButtonStyle     =   2
         PictureAlignment=   11
         BevelWidth      =   0
   ...
   Begin VB.Frame FRAME_CUR 
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_orders_def.frx":9032
         Alignment       =   8
         ButtonStyle     =   2
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_orders_def.frx":B957
      End
      Begin Threed.SSCommand cmdUndo 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "online_orders_def.frx":E1AB
         Alignment       =   8
         ButtonStyle     =   2
         PictureAlignment=   11
         BevelWidth      =   0
         PictureDisabledFrames=   1
         ShapeSize       =   1
         PictureDisabled =   "online_orders_def.frx":1030B
      End
   End
